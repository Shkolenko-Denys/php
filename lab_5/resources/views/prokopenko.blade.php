...
<head>
    ...
    <title>Прокопенко Анна Андріївна</title>
...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="educator-topic">Прокопенко Анна Андріївна</div>

        <div class="portfolio">
            <div class="image">
                <img src="../resources/img/container/prokopenko.png" alt="prokopenko-photo">
            </div>
            <div class="text">
                <p>Вік: 28 років</p>
