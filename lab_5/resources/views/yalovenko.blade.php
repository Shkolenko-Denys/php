...
<head>
    ...
    <title>Яловенко Олена Миколаївна</title>
...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="educator-topic">Яловенко Олена Миколаївна</div>

        <div class="portfolio">
            <div class="image">
                <img src="../resources/img/container/yalovenko.png" alt="yalovenko-photo">
            </div>
            <div class="text">
                <p>Вік: 30 років</p>
