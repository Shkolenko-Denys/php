...
<head>
    ...
    <title>Шпурик Вероніка Ігорівна</title>
...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="educator-topic">Шпурик Вероніка Ігорівна</div>

        <div class="portfolio">
            <div class="image">
                <img src="../resources/img/container/shpuryk.png" alt="shpuryk-photo">
            </div>
            <div class="text">
                <p>Вік: 25 років</p>
