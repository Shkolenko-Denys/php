...
<head>
    ...
    <title>Проценко Кароліна Віталіївна</title>
...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="educator-topic">Проценко Кароліна Віталіївна</div>

        <div class="portfolio">
            <div class="image">
                <img src="../resources/img/container/protsenko.png" alt="protsenko-photo">
            </div>
            <div class="text">
                <p>Вік: 25 років</p>
